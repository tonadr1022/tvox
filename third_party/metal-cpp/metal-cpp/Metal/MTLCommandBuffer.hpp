...
_MTL_INLINE MTL::ComputeCommandEncoder* MTL::CommandBuffer::computeCommandEncoder() {
  return Object::sendMessage<MTL::ComputeCommandEncoder*>(this,
...
_MTL_INLINE void MTL::CommandBuffer::presentDrawableAfterMinimumDuration(
  ...
  Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(presentDrawable_afterMinimumDuration_), drawable,
                            duration);
}
...
_MTL_INLINE void MTL::CommandBuffer::useResidencySets(
